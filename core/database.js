...
module.exports = class Database {
    ...
    constructor(client) {
        this.client = client;
        this.presence = mongoose.model("Presence", new mongoose.Schema({
            text: String,
            type: Number,
            url: String
        }));
    ...
    async connect() {
        ...
        try {
            ...
            const activeCollections = ['presences', 'guilds', 'autoplays', 'afks', 'noprefixes', 'playlists'];
            
            for (const collection of collections) {
                if (!activeCollections.includes(collection.name)) {
