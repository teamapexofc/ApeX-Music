...
module.exports = class Noprefix extends BaseCommand {
    ...
    async run(message, args, prefix) {
        ...
        if(opt === "add") {
            ...
            let btn1 = new ButtonBuilder().setLabel("Previous").setStyle(ButtonStyle.Secondary).setCustomId("previous-btn");
            let btn2 = new ButtonBuilder().setLabel("Stop").setStyle(ButtonStyle.Danger).setCustomId("stop-btn");
            let btn3 = new ButtonBuilder().setLabel("Next").setCustomId("next-btn").setStyle(ButtonStyle.Secondary);
