...
module.exports = class Queue extends BaseCommand {
    ...
    async run(message, args, prefix) {
        ...
        if(songs.length < 11) {
            ...
            let btn1 = new ButtonBuilder().setCustomId("previous").setLabel("Previous").setStyle(ButtonStyle.Secondary);
            let btn2 = new ButtonBuilder().setCustomId("stop").setLabel("Stop").setStyle(ButtonStyle.Danger);
            let btn3 = new ButtonBuilder().setCustomId("next").setLabel("Next").setStyle(ButtonStyle.Secondary);
