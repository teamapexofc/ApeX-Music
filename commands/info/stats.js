...
module.exports = class Stats extends BaseCommand {
    ...
    async run(message, args, prefix) {
        ...
        let btn2 = new ButtonBuilder().setLabel("General Info").setCustomId("general-info").setStyle(ButtonStyle.Secondary);
        let btn1 = new ButtonBuilder().setLabel("Team Info").setCustomId("team-info").setStyle(ButtonStyle.Secondary);
        let btn3 = new ButtonBuilder().setLabel("System Info").setCustomId("sys-info").setStyle(ButtonStyle.Secondary);
                ...
                if(interaction.customId === "sys-info") {
                    ...
                    let teamEmbed = new EmbedBuilder()
                        ...
                        .addFields([
                            {
                                name: 'Creator',
                                value: '**Alive** - Creator of Encore (main bot) and ApeX (open source)'
                            },
                            {
                                name: 'ApeX (This Bot)',
                                value: 'Open source version for learning and development'
                            },
                            {
                                name: 'Encore (Main Bot)',
                                value: 'Production bot with premium features - [Invite Here](https://encorebot.me)'
                            },
                            {
                                name: 'Contributors',
                                value: 'Community developers who help improve the open source code'
                            }
                        ])
                        .setFooter({
                            text: `Requested By: ${message.author.globalName ?? message.author.username}`,
