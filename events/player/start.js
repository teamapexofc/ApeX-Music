...
module.exports = class PlayerStart extends BaseEvent {
    ...
    async run() {
            ...
            let msg2 = await this.basePlayer.textChannel.send({
                ...
                components: [
                    new ActionRowBuilder().addComponents([
                        new ButtonBuilder().setLabel("Pause").setCustomId("pause-music").setStyle(ButtonStyle.Success),
                        new ButtonBuilder().setLabel("Previous").setCustomId("previous-music").setStyle(ButtonStyle.Secondary),
        ...
        let btn3 = new ButtonBuilder().setEmoji(this.client.emoji.setup.pause).setStyle(ButtonStyle.Secondary).setCustomId("setup-pause");
