...
module.exports = {
    ...
    createSetup: async function (client, guild, channel) {
        ...
        let btn1 = new ButtonBuilder().setEmoji(client.emoji.setup.previous).setStyle(ButtonStyle.Secondary).setCustomId("setup-previous");
        let btn2 = new ButtonBuilder().setEmoji(client.emoji.setup.stop).setStyle(ButtonStyle.Secondary).setCustomId("setup-stop");
        let btn3 = new ButtonBuilder().setEmoji(client.emoji.setup.pause).setStyle(ButtonStyle.Secondary).setCustomId("setup-pause");
        let btn4 = new ButtonBuilder().setEmoji(client.emoji.setup.loop).setStyle(ButtonStyle.Secondary).setCustomId("setup-loop");
        let btn5 = new ButtonBuilder().setEmoji(client.emoji.setup.skip).setStyle(ButtonStyle.Secondary).setCustomId("setup-skip");

        let btn6 = new ButtonBuilder().setEmoji(client.emoji.setup.volLow).setStyle(ButtonStyle.Secondary).setCustomId("setup-volLow");
        let btn7 = new ButtonBuilder().setEmoji(client.emoji.setup.clearQueue).setStyle(ButtonStyle.Secondary).setCustomId("setup-clearQueue");
        let btn8 = new ButtonBuilder().setEmoji(client.emoji.setup.shuffle).setStyle(ButtonStyle.Secondary).setCustomId("setup-shuffle");
        let btn9 = new ButtonBuilder().setEmoji(client.emoji.setup.autoplay).setStyle(ButtonStyle.Secondary).setCustomId("setup-autoplay");
        let btn10 = new ButtonBuilder().setEmoji(client.emoji.setup.volHigh).setStyle(ButtonStyle.Secondary).setCustomId("setup-volHigh");
